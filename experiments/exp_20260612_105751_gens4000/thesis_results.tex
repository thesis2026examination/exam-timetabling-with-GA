...
\begin{itemize}
    \item \textbf{Population Size:} $20$ individuals.
...
The algorithm was executed for $4000$ generations starting from the initialized population pool.
