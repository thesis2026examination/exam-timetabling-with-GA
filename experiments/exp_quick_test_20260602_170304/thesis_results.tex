...
Configuration 1 (Baseline / Standart) & 100 & 0.10 & 5 & 103.83 & 8589 & 153224 & 4980 & 2618 & 255359 \\
Configuration 2 (High Mutation / Exploration Focus) & 100 & 0.25 & 5 & 102.56 & 8472 & 156906 & 4985 & 2605 & 258281 \\
Configuration 3 (Large Population / Genetic Diversity) & 200 & 0.10 & 10 & 180.38 & 8258 & 153285 & 5008 & 2639 & 254192 \\
Configuration 4 (High Selection Pressure) & 100 & 0.10 & 15 & 88.11 & 7468 & 152743 & 4987 & 2652 & 249811 \\ \hline
\end{tabular}
\end{table}

As shown in Table~\ref{tab:ga_experiments}, the optimal (lowest) penalty score of \textbf{249811} was achieved by \textbf{Configuration 4 (High Selection Pressure)}. This outcome represents a \textbf{2.2\%} reduction in total penalty compared to the baseline configuration. A smaller population size paired with a lower mutation rate allowed this configuration to exploit promising local structures rapidly and fine-tune schedules without excessive stochastic disruption.

Conversely, the worst final performance was produced by \textbf{Configuration 2 (High Mutation / Exploration Focus)}, yielding a final penalty score of \textbf{258281}. The high mutation rate of $30\%$ disrupted high-quality schemas (building blocks) too frequently, inducing significant random perturbations and hindering convergence to a tighter, highly-optimized timetabling schedule.

From a computational perspective, doubling the population size in Configuration 3 led to a stable exploration process but increased the computational runtime by a factor of \textbf{1.74}, requiring \textbf{180.38} seconds. This underscores the typical trade-off between search breadth and time efficiency in evolutionary heuristics.
